...
import by.it_academy.jd2.messenger.model.storage.database.MessageDBStorage;
...
public class MessageService implements IMessageService {
    ...
    private MessageService() throws PropertyVetoException {
        //this.messageStorage = new MessageMemoryStorage();
        this.messageStorage = new MessageDBStorage();
    }
     ...
     */
    public static MessageService getInstance() throws PropertyVetoException {
        if (instance == null) {
