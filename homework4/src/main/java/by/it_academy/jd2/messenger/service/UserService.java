...
import by.it_academy.jd2.messenger.model.storage.database.UserDBStorage;
...
public class UserService implements IUserService {
    ...
    private UserService() throws PropertyVetoException {
     ...
     */
    public static UserService getInstance() throws PropertyVetoException {
        if (instance == null) {
     ...
     */
    @Override
    public void signUp(User user) throws IllegalArgumentException, IllegalAccessException {
     ...
     */
    @Override
    public User authentication(String name, String password) throws IllegalAccessException {
     ...
     */
    private synchronized void addUser(User user) throws IllegalArgumentException, IllegalAccessException {
