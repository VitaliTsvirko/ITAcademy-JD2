...
import by.it_academy.jd2.messenger.model.storage.memory.UserMemoryStorage;
...
class UserServiceTest {
    ...
    UserServiceTest() throws PropertyVetoException {
    }
    ...
    @Test
    void TestSignUp_NotUniqUserAdd() throws IllegalAccessException {
        this.user = new User("user",
                            "password",
                            "FirstName",
                            "LastName");
    ...
    @Test
    void TestAuthentication_EmptyLoginOrPassword() throws IllegalAccessException {
    ...
    @Test
    void TestAuthentication_IncorrectLoginOrPassword() throws IllegalAccessException {
        this.user = new User("user",
                "password",
                            "firstname",
                            "lastname");
    ...
    @Test
    void TestAuthentication_CorrectLoginOrPassword() throws IllegalAccessException {
    ...
    @Test
    void TestGetAllUser() throws IllegalAccessException {
